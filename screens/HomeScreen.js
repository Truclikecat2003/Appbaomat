...
const HomeScreen = () => {
  ...
  // ✅ Load avatar & lastLogin từ Firebase (bảng users)
  useEffect(() => {
    ...
    try {
      ...
      if (snapshot.exists()) {
        ...
        if (userId) {
          ...
          // console.log('✅ Avatar đã được lưu vào Firebase!');
        } else {
          console.warn('⚠️ Không tìm thấy người dùng để lưu avatar.');
        }
      }
    } catch (error) {
    ...
    <View style={styles.container}>
      {!isLoggedIn ? null : (
        <ScrollView style={styles.container}>
          ...
          {menuVisible && <MenuComponent username={username} />}
